...
@JSExportAll
final case class RotateAroundTweenParameters(d: Duration, val mesh: BABYLON.AbstractMesh, val axis: BABYLON.Vector3) 
...
object RotationTween {
  def rotateAround(duration: Duration, mesh: BABYLON.AbstractMesh, axis: BABYLON.Vector3, mgr: TweenManager) = 
